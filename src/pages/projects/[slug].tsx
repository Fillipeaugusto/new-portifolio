					...
					<div className="mt-6 max-w-2xl mx-auto pl-4 pr-4 sm:px-8  lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-1 lg:gap-x-8 ">
						...
						<div className="mt-4 lg:mt-0 lg:row-span-3 lg:max-w-5xl">
							...
							<div className="mt-10">
								...
								<button className="mt-10 w-full max-w-3xl bg-neutral-800 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-neutral-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-800">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										x="0px"
										y="0px"
						...
						<div className="mt-4  lg:mt-0 lg:row-span-3 task">
							...
							{ProjectMock.map((mock) => {
								return (
									<div
										key={mock.id}
										className="p-4 bg-white shadow-xl hover:shadow-2xl trasition delay-150 duration-300 max-w-xl rounded-xl flex justify-start dark:bg-neutral-50 hover:bg-neutral-100 md:flex-row flex-col gap-4 mb-4"
									>
										...
										<div className="flex flex-col justify-between">
											<div className="flex items-start justify-between text-gray-700  my-2 md:m-0">
												<p className="text-lg ">{mock.name}</p>
											</div>
